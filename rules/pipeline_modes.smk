...
if PIPELINE_MODE_RAW in {"reference", "build_reference", "build_ref"}:
    ...
    predict_targets = {"cnv_qc", "cnv", "branch_a_validation", "branch_b_evidence", "branch_s_review", "cnv_eval", "cnv_ml", "cnv_benchmark", "cnv_report"}
...
if CNV_ENABLED:
    AVAILABLE_TARGETS.update({"cnv_qc", "cnv", "reference_audit", "branch_a_validation", "branch_b_evidence", "branch_s_review", "cnv_eval", "cnv_ml", "cnv_benchmark", "cnv_report"})
...
MODE_TARGETS = {
    ...
    "predict": {"mapping", "metadata", "cnv_qc", "cnv", "reference_audit", "branch_a_validation", "branch_b_evidence", "branch_s_review", "cnv_eval", "cnv_ml", "cnv_benchmark", "cnv_report"},
}
